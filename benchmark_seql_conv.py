...
from utils.conv_sym_network import StackedConvNet
...
X_MINI_BATCH_SIZE = 16 # 16

RES_DIRECTORY = "benchmark-seql-conv/"
...
class Benchmark(benchmark.Benchmark):
    ...
    def train(self, func, train_data, test_data, func_name='', trials=1, func_dir='results/test'):
        ...
        sym = StackedConvNet(self.n_layers, funcs=self.activation_funcs, numW=numW)
        l_hat, y_hat = sym(x_placeholder)
        ...
        with tf.Session(config=config) as sess:
            for trial in range(trials):
                ...
                # Save data
                l_hat_repr, y_hat_norm = sess.run((l_hat, y_hat), feed_dict={x_placeholder: x_test})
